...
class ScoreSequenceTest {
    ...
    class MultiplePlayerTests {
        ...
        void givenTwoPlayers_whenBidZeroAndZeroTricks_scoreShouldBeTenEach() {
            List<Player> players = PlayerTestUtil.buildPlayerList(2);
            ...
            scoreSequence.tallyScores(players, bids, tricks);
    ...
    class SinglePlayerTests {
        ...
        void whenBidCorrectNumTricks_scoreShouldBeTenPlusTwoTimesBid(int bid, int numTricks) {
            List<Player> players = PlayerTestUtil.buildPlayerList(1);
            Map<Player, Integer> bids = Map.of(players.get(0), bid);
            Map<Player, Integer> tricks = Map.of(players.get(0), numTricks);
